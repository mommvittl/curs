...
function submitValidate(theUrlData,paramAddUpdData,viewResultAddElementFunct,idData,arrLengthValueData,event){
	...
	for (var i =0; i < this.elements.length; i++ ){
		if((this.elements[i].type != 'reset') && (this.elements[i].type != 'submit')){
			...
			if(!val || (val.length < arrLengthValue[activeTagName])) {  break; }
	...
	}else{ modalInformWindow("не все поля заполнены"); }		
	return false;
}
...
function onfocusValidate(){
	if( this.getAttribute('errorValueFlaf') == 1 ){
		...
		for(var i = 0; i < elem.length; i++){ this.parentElement.removeChild(elem[i]);  }
...
function oninputValidate(event,arrRightSymbolData,arrStrErrorData){
	var arrFunctionCharValid = {
		'name'	  : function(a){ return ( ((a>=48) && (a<=57)) || ((a>=65) && (a<=90)) || ((a>=97) && (a<=122)) || ((a>=1040) && (a<=1103)) || ( a==32) || (a==45)|| ( a==46) || (a==39) || (a==44) || (a==95) ) ? true : false ; },
		'surname' : function(a){ return ( ((a>=48) && (a<=57)) || ((a>=65) && (a<=90)) || ((a>=97) && (a<=122)) || ((a>=1040) && (a<=1103)) || ( a==32) || (a==45)|| ( a==46) || (a==39) || (a==44) || (a==95) ) ? true : false ; },
		'telephon': function(a){ return ( ((a>=48) && (a<=57)) || ( a==32) || (a==45)|| ( a==40) || (a==41) ) ? true : false ;  },
		'email'   : function(a){ return ( ((a>=48) && (a<=57)) || ((a>=65) && (a<=90)) || ((a>=97) && (a<=122)) || ( a==32) || (a==45)|| ( a==46) || (a==64) || (a==95) ) ? true : false ; },
		'skype'   : function(a){ return ( ((a>=48) && (a<=57)) || ((a>=65) && (a<=90)) || ((a>=97) && (a<=122)) || ( a==32) || (a==45)|| ( a==46) || (a==64) || (a==95) ) ? true : false ; },
		'adress'  : function(a){ return ( ((a>=32) && (a<=125)) || ((a>=1040) && (a<=1103)) ) ? true : false ;  },
		'birthday': function(a){ return ( ((a>=48) && (a<=57)) || ( a==32) || (a==45) ) ? true : false ;  },
		'title'   : function(a){ return ( ((a>=48) && (a<=57)) || ((a>=65) && (a<=90)) || ((a>=97) && (a<=122)) || ((a>=1040) && (a<=1103)) || ( a==32) || (a==45)|| ( a==46) || (a==39) || (a==44) || (a==95) ) ? true : false ; },
	'description' : function(a){ return ( ((a>=48) && (a<=57)) || ((a>=65) && (a<=90)) || ((a>=97) && (a<=122)) || ((a>=1040) && (a<=1103)) || ( a==32) || (a==45)|| ( a==46) || (a==39) || (a==44) || (a==95) ) ? true : false ; }	
	};
	var arrStrErrorIn = {
	...
	for(var i = 0; i < elem.length; i++){ this.parentElement.removeChild(elem[i]);  }
	this.setAttribute('errorValueFlaf',0);	
	for(var i = 0; i < val.length; i++){ if( !( arrRightSymbol[activeTagName](val.charCodeAt(i)) )) break; }
	if ( i != val.length ){
