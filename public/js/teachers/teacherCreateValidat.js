...
function oninputValidate(){
	...
	var funValid = function(activeTagName){
			switch(activeTagName){
				case 'telephon':
				return function(a){ return ( ((a>=48) && (a<=57)) || ( a==32) || (a==45)|| ( a==40) || (a==41) ) ? true : false ;  }
				break;
				case 'surname':
				case 'name':
				return function(a){return ( ((a>=48) && (a<=57)) || ((a>=65) && (a<=90)) || ((a>=97) && (a<=122)) || ((a>=1040) && (a<=1103)) || ( a==32) || (a==45)|| ( a==46) || (a==39) || (a==44) || (a==95) ) ? true : false ; }
				break;
				case 'email':
				case 'skype':
				return function(a){return ( ((a>=48) && (a<=57)) || ((a>=65) && (a<=90)) || ((a>=97) && (a<=122)) || ( a==32) || (a==45)|| ( a==46) || (a==64) || (a==95) ) ? true : false ;;}
				break;
				case 'adress':
	...
	for(var i = 0; i < val.length; i++){ if( !(funValid(activeTagName))(val.charCodeAt(i)) ) break; }
	if ( i != val.length ){
