...
//					var_dump($paramAddUpd);
					if($paramAddUpd == 'update'){
						...
						}else{ $this->strResponse .= "<flagResult>2</flagResult><resultAddTeacher>Некорректные данные</resultAddTeacher>"; } 						
					}else{
...
//					var_dump($this->teacher);
			...
			}else{ $this->strResponse .= "<flagResult>1</flagResult><resultAddTeacher>Error...ошибка передачи данных</resultAddTeacher>"; }			
//			var_dump($this->teacher);			
		}else{ $this->strResponse .= "<flagResult>1</flagResult><resultAddTeacher>Error...ошибка передачи данных</resultAddTeacher>"; }
